...
| Maintenance reporting | Weekly read-only quality report is proven on GitHub             | Pending | Expanded detector, baseline, pure-Markdown workflow, and configuration tests pass locally; live `workflow_dispatch` evidence is pending                                           |
