...
| Supply-chain security | Dependency automation, PR review, alerts, and CodeQL are proven | Pending | Dependabot-compatible pnpm 10 and commit-pinned Actions configured; alerts, security updates, and private reporting enabled; CodeQL run `30238344037` awaits Swift; dependency-review check awaits PR evidence |
