...
| Supply-chain security | Dependency automation, PR review, alerts, and CodeQL are proven | Pending | Repository config added; live GitHub controls still require provider evidence  |
